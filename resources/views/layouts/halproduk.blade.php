        ...
        <div class="text-left flex-1">
            ...
            <nav aria-label="Breadcrumb" class="mb-4">
                <ol class="flex items-center gap-2 text-sm text-[#74512D]">
                    <li>
                        <a href="/"
                            class="flex items-center gap-1 transition-colors text-[#74512D] hover:text-[#8B5A2B] font-medium"
                            aria-label="Home">
                    ...
                    <li class="rtl:rotate-180">
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 text-[#8B5A2B]/50" viewBox="0 0 20 20"
                            fill="currentColor">
