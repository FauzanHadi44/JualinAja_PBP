        ...
        <div class="grid items-start grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div class="py-6 px-8 max-lg:max-w-2xl">
                ...
                <div class="mt-8 space-y-4">
                    <button type="button"
                        class="w-full px-4 py-2.5 cursor-pointer border border-[#74512D] bg-transparent hover:bg-[#F2E7D8] text-[#74512D] text-sm font-medium rounded-md transition-all duration-200">Add
                        to cart</button>
                    <button type="button"
                        class="w-full px-4 py-2.5 cursor-pointer border border-[#74512D] bg-[#74512D] hover:bg-[#8B5A2B] text-white text-sm font-medium rounded-md transition-all duration-200">Buy
                        now</button>
                </div>
                ...
                button.addEventListener('click', function() {
                    ...
                    sizeButtons.forEach(btn => {
                        btn.classList.remove('bg-[#8B5A2B]', 'text-white',
                            'border-[#8B5A2B]');
                        btn.classList.add('bg-[#F2E7D8]', 'text-[#74512D]',
                            'border-[#D4AF37]/30');
                    });
