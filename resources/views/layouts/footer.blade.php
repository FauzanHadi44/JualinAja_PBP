<footer class="shadow-md bg-[#F2E7D8] border-t-2 border-[#74512D]/35">
    <div class="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        ...
        <p class="mx-auto mt-6 max-w-md text-center leading-relaxed text-[#74512D]/70">
        ...
        <ul class="mt-12 flex justify-center gap-6 md:gap-8">
            <li>
                ...
                rel="noreferrer"
                target="_blank"
                class="text-[#74512D]/70 transition hover:text-[#74512D]/75"
                >
        ...
        <div class="mt-12 pt-8 border-t border-[#74512D]/35">
            <div class="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
                <div class="text-center md:text-left">
                    <p class="text-sm text-[#74512D]">
                ...
                <div class="flex space-x-6 text-sm text-[#74512D]">
                    <a href="#" class="hover:text-[#74512D] transition-colors duration-300">Privacy Policy</a>
                    <a href="#" class="hover:text-[#74512D] transition-colors duration-300">Terms of Service</a>
                    <a href="#" class="hover:text-[#74512D] transition-colors duration-300">Contact Us</a>
                </div>
            </div>
        </div>
    </div>
